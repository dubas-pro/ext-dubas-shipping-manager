...
* It will start containers defined in `docker-compose.yml`
* It will create database defined in `config-default.json` or `config.json`
* It will run `node build --all` inside Docker

http://localhost:8080 - **EspoCRM**

http://localhost:8081 - **phpMyAdmin**

http://localhost:5000 - **smtp4dev**
...
```
docker-compose stop -v && docker-compose rm -f
```
...
```
vendor/bin/phpunit tests/unit/Espo/Modules/DubasShippingManager
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/DubasShippingManager
```
...
* `build`
* `site/build`
* `site/application/Espo/Modules/DubasShippingManager`
* `site/tests/unit/Espo/Modules/DubasShippingManager`
* `site/tests/integration/Espo/Modules/DubasShippingManager`
